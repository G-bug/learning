...
import com.learn.swagger.api.model.UnbindParam;
...
public class NotifyController {
    ...
    @ApiOperation(value = "解绑通知接口", notes = "后台管理员解绑网点绑定后需要调用此接口通知相应的pos机", produces = "application/json")
    @PostMapping("/unbind")
